...
### 建议你们组会时可以强调的一句话（老师大概率会喜欢）

> **ReasoningBank shifts agent memory from storing "what the agent did" to storing "why the agent succeeded or failed," making memory substantially more transferable across future tasks.**

这句话基本概括了整篇论文，也是它相较于 Synapse、AWM、Mem0 等工作的核心区别。
